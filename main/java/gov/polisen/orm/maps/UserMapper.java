...
public interface UserMapper {
    ...
    @Insert({
        ...
        "#{salt,jdbcType=CHAR}, #{passwordHash,jdbcType=CHAR})"
    })
    ...
    @ConstructorArgs({
        ...
        @Arg(column="password_hash", javaType=String.class, jdbcType=JdbcType.CHAR)
    })
    ...
    @Select({
        "select",
        "id, user_name, real_name, salt, password_hash",
        "from users",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @ConstructorArgs({
    ...
    @Update({
        ...
        "set user_name = #{userName,jdbcType=CHAR},",
          ...
          "password_hash = #{passwordHash,jdbcType=CHAR}",
        "where id = #{id,jdbcType=INTEGER}"
    })
