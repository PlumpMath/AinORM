...
import gov.polisen.orm.examples.ImageExample.Criteria;
import gov.polisen.orm.examples.ImageExample.Criterion;
...
public class ImageSqlProvider {
     ...
     * @mbggenerated Wed Apr 09 16:26:54 CEST 2014
     */
    protected void applyWhere(ImageExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
