...
import gov.polisen.orm.examples.PermissionsOnCaseExample.Criteria;
import gov.polisen.orm.examples.PermissionsOnCaseExample.Criterion;
import gov.polisen.orm.models.PermissionsOnCase;
import java.util.List;
import java.util.Map;

public class PermissionsOnCaseSqlProvider {
     ...
     */
    public String countByExample(PermissionsOnCaseExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Fri Apr 25 17:12:46 CEST 2014
     */
    public String deleteByExample(PermissionsOnCaseExample example) {
        BEGIN();
        DELETE_FROM("permissions_on_cases");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Fri Apr 25 17:12:46 CEST 2014
     */
    public String insertSelective(PermissionsOnCase record) {
        BEGIN();
        INSERT_INTO("permissions_on_cases");
        
        if (record.getDeviceId() != null) {
            VALUES("device_id", "#{deviceId,jdbcType=INTEGER}");
        }
        
        if (record.getCaseId() != null) {
            VALUES("case_id", "#{caseId,jdbcType=INTEGER}");
        }
     ...
     * @mbggenerated Fri Apr 25 17:12:46 CEST 2014
     */
    public String selectByExample(PermissionsOnCaseExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("device_id");
        } else {
            SELECT("device_id");
        }
        SELECT("case_id");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        PermissionsOnCase record = (PermissionsOnCase) parameter.get("record");
        PermissionsOnCaseExample example = (PermissionsOnCaseExample) parameter.get("example");
     ...
     * @mbggenerated Fri Apr 25 17:12:46 CEST 2014
     */
    public String updateByPrimaryKeySelective(PermissionsOnCase record) {
        BEGIN();
        UPDATE("permissions_on_cases");
     ...
     * @mbggenerated Fri Apr 25 17:12:46 CEST 2014
     */
    protected void applyWhere(PermissionsOnCaseExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
