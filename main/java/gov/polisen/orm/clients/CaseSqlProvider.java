...
public class CaseSqlProvider {
    ...
    public String insertSelective(Case record) {
        ...
        if (record.getFirstRevisionCaseId() != null) {
            VALUES("first_revision_case_id", "#{firstRevisionCaseId,jdbcType=INTEGER}");
        }
        
        if (record.getFirstRevisionDeviceId() != null) {
            VALUES("first_revision_device_id", "#{firstRevisionDeviceId,jdbcType=INTEGER}");
        }
        ...
        if (record.getTimeOfCrime() != null) {
            VALUES("time_of_crime", "#{timeOfCrime,jdbcType=TIMESTAMP}");
        }
    ...
    public String selectByExample(CaseExample example) {
        ...
        SELECT("first_revision_case_id");
        SELECT("first_revision_device_id");
